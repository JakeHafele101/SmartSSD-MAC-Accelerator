...
#define NUM_READ  1024

#define NUM_BLOCKS 800   //90 works, 200 works? 500 works? 1000 did not. 750 works? 900 did not. 800 works. 850 did not.
#define NUM_POINTS 1024

#define IN_OFFSET 10
#define WEIGHT_OFFSET 1010
#define OUT_FINAL_OFFSET 2010
...
//    }
    ...
    std::vector<float, aligned_allocator<float> > out_final(NUM_POINTS, 5);
	...
	//Create P2P Buffers
	cl_mem_ext_ptr_t inExtData, inExtWeight, outExtDataFinal;
    ...
    float actual_out = out_final[NUM_POINTS-1] + in_bias[NUM_POINTS-1] + out_init[NUM_POINTS-1];
