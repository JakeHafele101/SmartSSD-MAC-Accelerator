    ...
    class DenseLayer : public Layer {
        public:
            DenseLayer(const LayerParams inParams, const LayerParams outParams,
                ...
                : Layer(inParams, outParams, LayerType::DENSE, ActivationType::RELU), weightParam(weightParams), weightData(weightParams),
                  biasParam(biasParams), biasData(biasParams) {}
            DenseLayer(const LayerParams inParams, const LayerParams outParams,
                            const LayerParams weightParams, const LayerParams biasParams, ActivationType aType)
            : Layer(inParams, outParams, LayerType::DENSE, aType), weightParam(weightParams), weightData(weightParams),
                biasParam(biasParams), biasData(biasParams) {}
            DenseLayer(const LayerParams inParams, const LayerParams outParams,
                            const LayerParams weightParams, const LayerParams biasParams, ActivationType aType, bool perf)
            : Layer(inParams, outParams, LayerType::DENSE, aType, perf), weightParam(weightParams), weightData(weightParams),
                biasParam(biasParams), biasData(biasParams) {}
