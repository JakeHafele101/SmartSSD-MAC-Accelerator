    ...
    class FlattenLayer : public Layer {
        public:
            FlattenLayer(const LayerParams inParams, const LayerParams outParams)
                : Layer(inParams, outParams, LayerType::FLATTEN, ActivationType::NONE, false) {}
            FlattenLayer(const LayerParams inParams, const LayerParams outParams, bool perf)
                : Layer(inParams, outParams, LayerType::FLATTEN, ActivationType::NONE, perf) {}
